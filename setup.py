...
setup(name='EODataDown',
    ...
    scripts=['bin/eoddsetup.py', 'bin/eoddrun.py', 'bin/eoddpassencode.py', 'bin/eoddexport.py',
             'bin/eoddgenscncmds.py', 'bin/eoddsenroi.py', 'bin/eoddresetimgs.py'],
    packages=['eodatadown'],
    ...
    data_files=[(os.path.join('share','eodatadown'),
                ...
                [os.path.join('share','eodatadown', 'dc_prod_specs', 'arcsi_l4_prod_spec.yaml'),
                 os.path.join('share','eodatadown', 'dc_prod_specs', 'arcsi_l5_prod_spec.yaml'),
                 os.path.join('share','eodatadown', 'dc_prod_specs', 'arcsi_l7_prod_spec.yaml'),
                 os.path.join('share','eodatadown', 'dc_prod_specs', 'arcsi_l8_prod_spec.yaml'),
