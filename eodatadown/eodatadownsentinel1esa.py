    ...
    def scn2tilecache(self, unq_id):
        ...
        if query_result is not None:
            ...
            tmp_tilecache_path = os.path.join(self.ardProdTmpPath,
                                              "webcache_{}_{}".format(query_result.Identifier, query_result.PID))
